...
@section('meta')
	...
	<meta property="og:description"   content="Ver y descargar películas genero @yield('genre') online en full HD 1080p y audio latino gratis!. Descargas a 1 solo link desde MEGA" />
...
@section('title')
	@if(Request('page') && Request('page')!='1' )
		{{ Request('page').' - ' }}
	@endif
	Ver Peliculas genero @yield('genre') Online o Descargar HD gratis
@endsection

@section('jumbotron-h1')
	Ver y descargar películas genero @yield('genre') online HD 1080p audio latino gratis
@endsection
